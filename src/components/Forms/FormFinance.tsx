...
const FormFinance: React.FC<Props> = ({existingFinance, onSubmit, isLoading = false})=>{
    ...
    const [financeInfo, setFinanceInfo] = useState<ApiIncomeExpense>(initialState)
        ...
        <form onSubmit={onFormSubmit}>
            <div className="container">
                ...
                <div className="mb-3">
                    ...
                    <select name="category" className="form-control" onChange={changeFinance} defaultValue={oneCategory[financeInfo.category]?.name}>
                        {categoriesLoading ? (
                            <Spinner />
                            ) : (
